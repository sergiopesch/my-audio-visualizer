# Audio Visualizer V1 — archived README

> Historical document preserved from commit `065e80f`, immediately before the AV/01 rebuild. It describes the old application and should not be used as current setup guidance. The demo-image path is the only adjustment.
